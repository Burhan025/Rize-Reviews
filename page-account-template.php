...
<div class="new-admin-profile">
 <div id="cus-sidebar" class="profile-sidebar">
 	 	<ul id="sidemenu">
 	 		...
 	 		<li>
 	 			<a class="active" href="/account-info/">
	  ...
	  <div class="profile-content">
		...
		<div class="wrap">
	     <h1 class="entry-title" itemprop="headline">Account Information</h1>
		 <h2 class="subheading">Update your account information</h2>
		</div>
		</div>
		
		<div class="profile-form-back"> 		 
		 <div class="account-info-update"><?php echo do_shortcode('[ultimatemember_account]'); ?></div> 
		</div>
