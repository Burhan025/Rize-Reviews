...
<div class="et_pb_section et_pb_fullwidth_section  et_pb_section_0 et_section_regular">
					<div class="et_pb_module et_pb_post_title   et_pb_fullwidth_post_title_0 et_pb_bg_layout_light et_pb_featured_bg"> 
						<div class="et_pb_title_container">
							...
							Best <?php $catname = get_queried_object(); echo $catname->name; ?> Companies
                                                    </h1>	
						</div>				
					</div>				
				</div>
<div id="main-content">
	<div class="wrap">
            ...
            <h2>Find Top <?php $catname = get_queried_object(); echo $catname->name; ?></h2>
    <?php
  ...
  ?>
  <!--<div class="otherservices mmm">	
  
    <h3>Related Categories</h3>  
    <?php //the_field ('list_related_categories', $taxonomy . '_' . $term_id); ?>
